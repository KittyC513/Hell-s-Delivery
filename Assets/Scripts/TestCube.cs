    ...
    void Update()
    {
        ...
        else
        {
            if (playerCamera != null || mainCam != null)
            {
                ...
                {
                    charController.RunMovement(mainCam, canParachute, move.ReadValue<Vector2>(), jump, parachuteObj, tooHeavy);                  
                    //print("use new movementCal");
                }
                else
                {
                    charController.RunMovement(playerCamera, canParachute, move.ReadValue<Vector2>(), jump, parachuteObj, tooHeavy);                    
                    //print("use new movementCal");
